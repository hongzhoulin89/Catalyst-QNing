...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    /* Define variables*/
    double *Y, *X, *W, *Nb_it,*Y_k,*Dualgap, L, Lips, lambda, theta, z, value,deriv,loss_value,delta,dualgap,update_parameter,deriv_tilde,kappa,deriv_norm,para1,small_epsilon,threshold,threshold2,infnorm,dualcoeff;
    ...
    if(nrhs < 9) /* If Alpha is unspecified, set it to a default value */
    {
        ...
        mexErrMsgTxt("eta must be a int scalar.");
    else // Get m
    {
